        ...
        <section className="bg-white ">
            <div className="flex justify-center min-h-screen">
                ...
                <div className="lg:grid lg:min-h-screen lg:max-w-[35%]">
                    <section className="right-slide relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                        <Link to='/' className="absolute top-5 flex justify-between items-center gap-2 left-10 text-white">
                            <IoHomeOutline />
                            Home
                        </Link>
                        ...
                        <div className="hidden lg:relative lg:block lg:p-12">
                            <a className="block text-white" href="/">
                                ...
                                <img src="../assets/images/logo.png" className="w-auto h-[50px]" alt="logo img" />
                            </a>
                ...
                {/* ALL LOGIN RELATED COMPONENTS PASS HERE */}
                {children}
